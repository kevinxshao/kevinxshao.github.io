...
function reauthenticate(){
    ...
    // User re-authenticated.
        //var user = firebase.auth().currentUser;
        var newEmail =  document.getElementById("newemail_field").value;
        var confirmEmail = document.getElementById("confirmemail_field").value;
        if(newEmail==confirmEmail){
            user.updateEmail(newEmail).then(function() {
            // Update successful.
                window.alert("Email Changed Successful Please Log in again");
                logout();
            }).catch(function(error) {
            // An error happened.
            window.alert(error);
