...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tns="https://interdark.com/EmbeddedSystemsPage/embeddedsystems.xml">
    <xsl:output method="html" doctype-system="about:legacy-compat"/>
    <xsl:template match="/">
        <html>
            <head>
                <title>InterDark | Embedded Systems</title>
                <meta name="viewport" content="width=device-width, initial-scale=1"/>
                 <link rel="shortcut icon" href="../../Pictures/interdarklogo.ico" />
                <link rel="stylesheet" href="embeddedsystems.css"/>
            ...
            <body onload="loadTime()" id="body1">
                ...
                <div id="blogpost">
                    <div class="header">
                        <h2 style="font-style: italic;">Embedded Systems</h2>
                    </div>
                ...
                <script src="embeddedsystemsload.js"></script>  
            </body>
        </html>
    </xsl:template>
</xsl:stylesheet>